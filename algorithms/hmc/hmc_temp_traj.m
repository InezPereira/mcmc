...
function [sample, reject] = hmc_temp_traj(U, grad_U, mu, Sigma, epsilon, randomize_epsilon, L,randomize_L, current_q, reject, temp)
...
elseif randomize_L~=0 && randomize_L ~=1
    ...
    if randomize_epsilon == 1
        ...
        if randomize_L == 1 % Randomize both epsilon and L
            ...
            [q, p] = leapfrog_temp(p, epsilon, q, U, grad_U, L, Sigma, temp);
