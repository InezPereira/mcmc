...
save('samples_mixt_mat', 'samples_mixt_mat')
...
save('samples_hybrid_mat','samples_hybrid_mat')

% samples_hybrid_mat = load('samples_hybrid_mat.mat')

figure(4)
histogram(samples_hybrid_mat.samples_hybrid_mat, 'FaceColor', [254,178,76]/255, 'NumBins', 100);
