...
function samples = mh_random_walk(n_iter, initial_state, Sigma, weights, mu_tilde, sigma_tilde)
    ...
    for ii=1:n_iter
        ...
        p_tilde_x_prime = gaussian_mix(x_prime, mu_tilde, [1,1], sigma_tilde, 0);
        q_x_given_x_prime = gaussian_mix(x, [x_prime, mu_tilde], [1, sigma_tilde], weights, 0);
        p_tilde_x = gaussian_mix(x, mu_tilde, [1,1], sigma_tilde, 0);
        q_x_prime_given_x = gaussian_mix(x_prime, [x, mu_tilde], [1, sigma_tilde], weights, 0);
